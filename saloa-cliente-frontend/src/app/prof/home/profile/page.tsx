import { NavLogoutProf } from "@/components/prof/nav/nav-logout";
...
import { getUserMeServiceServerProf } from "@/services/prof/server/user.service";
import { faUser } from "@fortawesome/free-regular-svg-icons";
import { faLock } from "@fortawesome/free-solid-svg-icons";

export default async function Profile() {
  const user = await getUserMeServiceServerProf();
