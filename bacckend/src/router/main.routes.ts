...
mainRouter.get('/users/:id', verifyJWT, authorizeRoles("ADMIN"), usersController.getUserById)
...
mainRouter.get('/appointments', verifyJWT, authorizeRoles("ADMIN", "PROFESSIONAL"), agendaController.getAllAppointments)
...
mainRouter.get('/clients', verifyJWT, clientController.getAllClients)
